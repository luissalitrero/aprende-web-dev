let arrays = {
  courses: [{
      ...
      logo: {src: 'images/logos/html5-logo.png', alt: "Logo de HTML5", title: "Logo de HTML5", class: "html5"},
      title: "HTML5"
    }, {
      _id: "css3-course-id",
      ...
      logo: {src: 'images/logos/css3-logo.png', alt: "Logo de CSS3", title: "Logo de CSS3", class: "css3"},
      title: "CSS3"
    }, {
      _id: "less-course-id",
      ...
      logo: {src: 'images/logos/less-logo.png', alt: "Logo de LESS", title: "Logo de LESS", class: "less"},
      title: "LESS"
    }, {
      ...
      logo: {src: 'images/logos/bootstrap-logo.png', alt: "Logo de Bootstrap", title: "Logo de Bootstrap", class: ""},
      title: "Bootstrap3"
    }, {
      ...
      logo: {src: 'images/logos/javascript-logo.png', alt: "Logo de Javascript", title: "Logo de Javascript", class: "javascript"},
      title: "Javascript"
    }, {
